        ...
        <div className="grid gap-6 xl:grid-cols-[1.02fr,0.98fr]">
          ...
          <div className="card-soft space-y-6 p-6 sm:p-8">
            ...
            <div className="flex items-center justify-between border-t border-line/40 pt-4">
              <p className="text-base text-inksoft/70 sm:text-lg">{statusText}</p>
            </div>
            ...
            {!loading && !error && showSlots && (
              <div className="space-y-3">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-1 text-[15px] uppercase tracking-[0.2em] text-bronze/60 transition hover:text-bronze"
