      ...
      <div className="section-shell">
        ...
        >
          ...
          <div className="mt-8 flex flex-nowrap items-center justify-center gap-2 sm:justify-start sm:gap-3">
            <Link
              href="#galerie"
              className="flex flex-col items-center rounded-[7px] border border-white/60 bg-black/20 px-4 py-2.5 text-[17px] font-medium leading-[1.1] text-white transition sm:rounded-[10px] sm:bg-transparent sm:px-5 sm:py-2.5 sm:text-[17px] hover:bg-white hover:text-espresso"
            >
              <span>Descoperă</span>
              <span>Salonul</span>
            </Link>
